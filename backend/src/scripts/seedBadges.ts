...
export const seedBadges = async () => {
	...
	const themeIntermediaire = await Theme.findOne({
		slug: "theme-intermediaire",
	});
	...
	console.log(
		"- Intermédiaire:",
		themeIntermediaire?.name,
		"(slug:",
		themeIntermediaire?.slug,
		")",
	);
	...
	const sampleBadges = [
		{
			...
			iconUrl:
				"https://raw.githubusercontent.com/katalinadnl/TSness-Nodejs/refs/heads/feat/badges/backend/assets/icons/debutant.png",
		...
		},
		{
			...
			iconUrl:
				"https://raw.githubusercontent.com/katalinadnl/TSness-Nodejs/refs/heads/feat/badges/backend/assets/icons/qualite.png",
		...
		},
		{
			...
			iconUrl:
				"https://raw.githubusercontent.com/katalinadnl/TSness-Nodejs/refs/heads/feat/badges/backend/assets/icons/football.png",
